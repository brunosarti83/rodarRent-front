        ...
        <div className="w-full 2xl:h-noNavDesktop lg:h-noNavLaptop bg-white dark:bg-slate-900 duration-300 dark:text-gray-100 flex items-center justify-center" >
            <div className="drop-shadow-md border bg-white rounded-l-3xl  dark:bg-slate-900" >
                <form className="px-16  py-5 flex flex-col flex-wrap w-full rounded-xl">
                    ...
                    <label className="font-poppins text-sm flex m-1 justify-start" htmlFor="name">
                        Name
                    </label>
                    <input
                    ...
                    <label className="font-poppins text-sm flex m-1 justify-start" htmlFor="email">
                        E-mail
                    </label>
                    <input
                        className="font-poppins  text-sm flex justify-start items-center p-1 m-1 rounded-lg drop-shadow-md border border-gray dark:bg-slate-950"
                    ...
                    <div className='flex' >
                        ...
                        <div>
                            <label className="font-poppins text-sm flex m-1 justify-start" htmlFor="city">
                                City
                            </label>
                            <input
                                className="font-poppins text-sm flex justify-start items-center p-1 m-1 rounded-lg drop-shadow-md border border-gray dark:bg-slate-950"
