...
function Landing() {
    ...
    return (
        <div className=' bg-white transition duration-300 dark:bg-slate-900 text-black dark:text-gray-100 h-noNav flex flex-col' >
            <div className='flex'>
                ...
                <div data-aos="fade-left" data-aos-duration="2000" data-aos-delay="800" className='relative w-3/5 h-landing overflow-x-hidden' >
                    <img className='absolute scale-110  top-52 left-64' src={landingImage} alt="" />
                </div>
            </div>
            <div data-aos="fade-zoom-in"
                ...
                data-aos-delay="500"
                data-aos-offset="0" className='flex flex-grow-1  mt-20 items-center p-2  justify-between'>
