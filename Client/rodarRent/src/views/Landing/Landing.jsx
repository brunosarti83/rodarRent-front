...
function Landing() {
    ...
    return (
        <div className=' bg-white transition duration-300 dark:bg-slate-900 text-black dark:text-gray-100 min-h-[calc(100vh-66px)] flex flex-col justify-between' >
            <div className='flex'>
                ...
                <div data-aos="fade-zoom-in" data-aos-duration="2000" data-aos-delay="1500" className='relative w-3/6 2xl:h-landingLaptop xl:h-landingLaptop lg:h-landingLaptop md:h-landingMd overflow-x-hidden' >
