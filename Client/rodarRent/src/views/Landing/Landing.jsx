        ...
        <div className=' bg-white transition duration-300 dark:bg-slate-900 text-black dark:text-gray-100 min-h-[calc(100vh-112px)] flex flex-col justify-between' >
            <div className='flex'>
                <div data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" data-aos-duration='1000' data-aos-delay='300' className='font-poppins 2xl:pl-20 xl:pl-16 lg:pl-14 md:pl-10 xs:pl-2 pt-10 lg:pt-16 w-3/6'>
            ...
            <div className=' 2xl:h-32 xl:h-32 lg:h-32 md:w-auto flex flex-row 2xl:flex-nowrap xl:flex-nowrap lg:flex-nowrap md:flex-wrap xs:flex-wrap items-center justify-evenly'>
                {brandLogos.map((brand, index) => (
                    <div className='2xl:w-full xl:w-full lg:w-full md:w-1/5 xs:w-1/4 ' key={index} >
