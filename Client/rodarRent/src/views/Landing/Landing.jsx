    ...
    <div className=" bg-white transition duration-300 dark:bg-slate-900 text-black dark:text-gray-100 min-h-[calc(100vh-112px)] flex flex-col justify-between">
      <div className="flex">
        <div
          ...
          data-aos-delay="300"
          className="font-poppins 2xl:pl-20 xl:pl-16 lg:pl-14 md:pl-10 xs:pl-2 pt-10 lg:pt-16 w-3/6"
        >
          <div className="2xl:text-landing2Xl xl:text-landingXl lg:text-landingLg md:text-landingMd sm:text-landingMd xs:text-landingMobile font-extrabold">
            <h1>Premium</h1>
            <h1>Car Rental</h1>
            <h1>In Argentina</h1>
          </div>
        ...
        <div
          ...
          data-aos-delay="1500"
          className="relative w-3/6 2xl:h-[calc(100vh-240px)] xl:h-[calc(100vh-240px)] lg:h-[calc(100vh-240px)] md:h-landingMd xs:h-landingXs overflow-x-hidden"
        >
          <img
            className="absolute 2xl:scale-125 xl:scale-150 lg:scale-150 md:scale-215 xs:scale-200 2xl:top-64 xl:top-60 lg:top-56 md:top-96 xs:top-80 left-52 md:left-48  xs:left-28 "
            src={landingImage}
            alt=""
          />
        </div>
