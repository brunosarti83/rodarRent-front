...
function Landing() {
    ...
    return (
        <div className=' bg-white transition duration-300 dark:bg-slate-900 text-black dark:text-gray-100 2xl:h-noNavDesktop lg:h-noNavLaptop flex flex-col' >
            <div className='flex'>
                <div data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" data-aos-duration='1000' data-aos-delay='300' className='font-poppins pl-28 pt-10 w-2/5'>
                    <div className='2xl:text-landingDesktop lg:text-landingLaptop  font-extrabold' >
                        <h1>Premium</h1>
                        <h1>Car Rental</h1>
                        <h1>In Argentina</h1>
                    </div>
                ...
                <div data-aos="fade-zoom-in" data-aos-duration="2000" data-aos-delay="1500" className='relative w-3/5 2xl:h-landingDesktop lg:h-landingLaptop overflow-x-hidden' >
                    <img className='absolute scale-110  2xl:top-52  lg:top-40 left-64' src={landingImage} alt="" />
                </div>
            </div>
            <div data-aos="fade-zoom-in"
                ...
                data-aos-delay="500"
                data-aos-offset="0" className='flex items-center p-2  justify-between'>
                {brandLogos.map((brand, index) => (
                    <div className='2xl:w-36  lg:w-32' key={index} >
